...
export default function StickyWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 w-14 h-14 rounded-full bg-[#25D366] hover:bg-[#1EBE57] shadow-lg flex items-center justify-center transition-transform hover:scale-105"
    >
