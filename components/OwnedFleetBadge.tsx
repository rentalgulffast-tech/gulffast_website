...
export default function OwnedFleetBadge({ categoryName, ownedFleetCount }: OwnedFleetBadgeProps) {
  if (ownedFleetCount > 0) {
    return (
      <div className="w-full flex items-center gap-4 bg-white border-2 border-[#12233B]/10 rounded-2xl px-6 py-5 shadow-sm">
        <span className="shrink-0 w-12 h-12 rounded-xl bg-[#EAF4FC] border border-[#D7E6F5] text-[#2B6CB0] flex items-center justify-center text-xl font-black">
          {ownedFleetCount}
        </span>
        <div>
          <p className="text-sm font-extrabold text-[#12233B]">
  ...
  return (
    <div className="w-full flex items-center gap-4 bg-white border-2 border-[#D7E6F5] rounded-2xl px-6 py-5 shadow-sm">
      <span className="shrink-0 w-12 h-12 rounded-xl bg-[#EAF4FC] border border-[#D7E6F5] text-[#12233B] flex items-center justify-center">
