...
export default function ServiceAreaMap() {
  ...
  return (
    <div className="bg-white border border-[#D7E6F5] rounded-2xl p-6 sm:p-8 shadow-sm">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-[#D7E6F5] mb-6">
        <div>
          <span className="text-xs font-bold uppercase tracking-wider text-[#2B6CB0] bg-[#EAF4FC] px-3 py-1 rounded-full border border-[#D7E6F5]">
            Kingdom-Wide Fleet Dispatch
          </span>
          <h2 className="text-2xl sm:text-3xl font-extrabold text-[#12233B] mt-2">
            Where We Work
          </h2>
        ...
        <div className="flex items-center gap-3 bg-[#EAF4FC] px-4 py-2 rounded-xl text-xs shrink-0 border border-[#D7E6F5]">
          <span className="w-3 h-3 rounded-full bg-[#2B6CB0] animate-pulse"></span>
          <span className="font-bold text-[#12233B]">Al Khobar Operational HQ</span>
        </div>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        {/* SVG Interactive Map Container */}
        <div className="lg:col-span-7 relative bg-[#EAF4FC] rounded-xl border border-[#D7E6F5] p-4 sm:p-8 min-h-[340px] flex items-center justify-center overflow-hidden">

          {/* Stylized KSA Map Outline SVG */}
          <svg className="w-full h-auto max-h-[320px] text-[#D7E6F5]" viewBox="0 0 500 400" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
            ...
            <path
              ...
              opacity="0.3"
            />
            <line x1="50" y1="100" x2="450" y2="100" stroke="#D7E6F5" strokeWidth="1" />
            <line x1="50" y1="200" x2="450" y2="200" stroke="#D7E6F5" strokeWidth="1" />
            <line x1="50" y1="300" x2="450" y2="300" stroke="#D7E6F5" strokeWidth="1" />
          </svg>
            ...
            return (
              ...
              >
                <span className="relative flex items-center justify-center">
                  {isActive && (
                    <span className="absolute w-8 h-8 rounded-full bg-[#2B6CB0]/20 animate-ping"></span>
                  )}
                  <span
                    className={`w-5 h-5 rounded-full flex items-center justify-center border-2 shadow-md transition-transform duration-200 ${
                      isActive
                        ? 'bg-[#2B6CB0] border-white scale-125'
                        : 'bg-[#12233B] border-white group-hover:scale-110'
                    }`}
                  >
                ...
                <span
                  className={`mt-1 inline-block px-2 py-0.5 rounded text-[10px] font-bold whitespace-nowrap shadow-sm transition-colors ${
                    isActive
                      ...
                      : 'bg-white text-[#12233B] border border-[#D7E6F5]'
                  }`}
                >
                  {hub.name}
                </span>
        ...
        <div className="lg:col-span-5 bg-[#EAF4FC] border border-[#D7E6F5] rounded-xl p-6 space-y-4">
          <div className="flex items-center justify-between border-b border-[#D7E6F5] pb-3">
            <div>
              <span className="text-[11px] font-bold uppercase tracking-wider text-[#2B6CB0]">
                {activeHub.region}
              </span>
              <h3 className="text-xl font-extrabold text-[#12233B]">{activeHub.name}</h3>
            </div>
            <span className="w-8 h-8 rounded-lg bg-white border border-[#D7E6F5] flex items-center justify-center text-sm font-bold text-[#12233B]">
              📍
            </span>
          </div>
          ...
          <div className="space-y-3 text-xs">
            <div>
              <span className="font-bold text-[#12233B] block mb-0.5">Coverage Focus:</span>
