      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-slate-800">
          ...
          <div className="lg:col-span-2 space-y-4">
            <Link href="/" className="inline-block">
              <div className="relative w-52 h-14 bg-white/5 p-2 rounded">
                <Image
                  src="/logo.svg"
            ...
            <div className="space-y-2 pt-2 text-xs text-slate-300">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <span>
                  ...
                  <a href="tel:+966568676710" className="hover:text-amber-400 transition-colors font-semibold">+966 56 867 6710</a>{' '}/{' '}
                  <a href="tel:+966538321732" className="hover:text-amber-400 transition-colors font-semibold">+966 53 832 1732</a>
                </span>
              </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li><Link href="/about" className="hover:text-amber-400 transition-colors">About Corporate</Link></li>
              <li><Link href="/industries" className="hover:text-amber-400 transition-colors">Industries Served</Link></li>
              <li><Link href="/projects" className="hover:text-amber-400 transition-colors">Project Portfolio</Link></li>
              <li><Link href="/faq" className="hover:text-amber-400 transition-colors">FAQ &amp; Compliance</Link></li>
              <li><Link href="/contact" className="hover:text-amber-400 transition-colors">Contact Head Office</Link></li>
              <li><Link href="/request-a-quote" className="hover:text-amber-400 transition-colors text-amber-400 font-bold">Request a Quote →</Link></li>
        ...
        <div className="py-6 border-b border-slate-800 text-xs">
          <div className="flex flex-wrap items-center gap-2">
            <span className="text-slate-200 font-bold uppercase text-[11px]">KSA Service Footprint:</span>
            {cities.map((city) => (
              <span key={city} className="bg-slate-800 border border-slate-700 text-slate-300 px-2.5 py-1 rounded text-[11px]">
                {city}
              </span>
            ))}
          </div>
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-400">
          ...
          <div className="flex items-center gap-4 text-slate-400">
            ...
            <span>•</span>
            <Link href="/faq" className="hover:text-amber-400 transition-colors">Safety &amp; Compliance</Link>
          </div>
        </div>
      </div>
    </footer>
