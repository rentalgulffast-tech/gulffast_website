...
export default function ServicePillars() {
  return (
    <section className="py-12 bg-[#F5F2EB] text-[#1E293B]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <div className="text-center max-w-3xl mx-auto mb-10">
          <span className="text-[#C2410C] font-bold text-xs uppercase tracking-widest bg-[#FFF7ED] px-3 py-1 rounded-full border border-[#FFEDD5]">
            Our 3 Core Industrial Pillars
          </span>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-[#0F2942] mt-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white border border-[#E2DED4] rounded-2xl p-8 card-hover-lift flex flex-col justify-between group shadow-sm">
            <div>
              <div className="w-12 h-12 rounded-xl bg-[#FFF7ED] border border-[#FFEDD5] flex items-center justify-center text-[#C2410C] mb-6">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                </svg>
              </div>
              <h3 className="text-2xl font-extrabold text-[#0F2942] mb-3 group-hover:text-[#C2410C] transition-colors">
                Equipment Rental
              </h3>
            ...
            <Link
              ...
              className="inline-flex items-center gap-1.5 text-[#C2410C] font-bold text-xs uppercase tracking-wider hover:underline"
            >
