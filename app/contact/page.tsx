      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 my-8">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-white border border-[#D7E6F5] rounded-2xl p-6 shadow-sm space-y-4">
              <h2 className="text-xl font-extrabold text-[#12233B] border-l-4 border-[#2B6CB0] pl-3">
              ...
              <div className="space-y-3 text-xs text-slate-700">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <strong className="text-[#12233B] block">Physical Address:</strong>
                ...
                <div className="flex items-start gap-3 pt-2 border-t border-[#D7E6F5]">
                  <span className="text-base shrink-0">📞</span>
                  <div>
                    <strong className="text-[#12233B] block">Direct Sales Hotlines:</strong>
                    <a href="tel:+966568676710" className="text-[#2B6CB0] font-bold block hover:underline">+966 56 867 6710</a>
                    <a href="tel:+966538321732" className="text-[#2B6CB0] font-bold block hover:underline">+966 53 832 1732</a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 pt-2 border-t border-[#D7E6F5]">
                  ...
                  <div>
                    <strong className="text-[#12233B] block">Official Email:</strong>
                    <a href="mailto:sales@gulffast.co" className="text-[#12233B] font-semibold hover:underline">sales@gulffast.co</a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 pt-2 border-t border-[#D7E6F5]">
                  <span className="text-base shrink-0">⏰</span>
                  <div>
                    <strong className="text-[#12233B] block">Working Hours:</strong>
                    <span>Sunday – Thursday: 07:30 AM – 05:30 PM (AST)</span>
                    <span className="block text-[#2B6CB0] font-semibold mt-0.5">24/7 Emergency Site Dispatch Available</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-[#D7E6F5] rounded-2xl p-6 shadow-sm text-center space-y-3">
              <h3 className="text-base font-bold text-[#12233B]">Al Khobar Operations Yard Location</h3>
              <div className="bg-[#EAF4FC] border border-[#D7E6F5] rounded-xl p-8 text-xs text-slate-500 font-mono">
