      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 my-8">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-white border border-border rounded-2xl p-6 shadow-sm space-y-4">
              ...
              <div className="space-y-3 text-xs text-slate-700">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <strong className="text-primary block">Physical Address:</strong>
                ...
                <div className="flex items-start gap-3 pt-2 border-t border-border">
                  <span className="text-base shrink-0">⏰</span>
                  <div>
                    <strong className="text-primary block">Working Hours:</strong>
                    <span>Sunday – Thursday: 07:30 AM – 05:30 PM (AST)</span>
                    <span className="block text-accent-strong font-semibold mt-0.5">24/7 Emergency Site Dispatch Available</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-border rounded-2xl p-6 shadow-sm text-center space-y-3">
              <h3 className="text-base font-bold text-primary">Al Khobar Operations Yard Location</h3>
              <div className="bg-tint border border-border rounded-xl p-8 text-xs text-slate-500 font-mono">
