    ...
    <div className="py-10 bg-white text-[#12233B] min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-8 text-xs text-slate-600">
          <div className="bg-white border border-[#D7E6F5] p-4 rounded-2xl text-center space-y-1 shadow-sm">
            <span className="text-[#12233B] font-bold text-sm block">⚡ 2-Hour Response</span>
            <p>Our sales engineers review requests during working hours (07:30 - 17:30 AST).</p>
          </div>
          <div className="bg-white border border-[#D7E6F5] p-4 rounded-2xl text-center space-y-1 shadow-sm">
            <span className="text-[#12233B] font-bold text-sm block">📋 Gate Pass Ready</span>
            <p>All quote options include site gate pass processing support.</p>
          </div>
          <div className="bg-white border border-[#D7E6F5] p-4 rounded-2xl text-center space-y-1 shadow-sm">
            <span className="text-[#12233B] font-bold text-sm block">📞 Hotline Support</span>
