      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white border border-[#D7E6F5] rounded-2xl p-8 shadow-sm space-y-8 text-sm text-slate-700 leading-relaxed">
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-extrabold text-[#12233B]">1. Introduction</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-extrabold text-[#12233B]">2. Information We Collect</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-extrabold text-[#12233B]">3. How We Use Your Information</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-extrabold text-[#12233B]">4. Data Sharing</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-extrabold text-[#12233B]">5. Data Retention</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-extrabold text-[#12233B]">6. Your Rights</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-extrabold text-[#12233B]">7. Contact Us</h2>
            <p>
