  ...
  return (
    <div className="py-10 bg-white text-[#12233B] min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white border border-[#D7E6F5] rounded-2xl p-8 shadow-sm space-y-8 text-sm text-slate-700 leading-relaxed">

          <section className="space-y-2">
            <h2 className="text-lg font-extrabold text-[#12233B]">1. Acceptance of Terms</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-extrabold text-[#12233B]">2. Nature of Services</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-extrabold text-[#12233B]">3. Quotations and Pricing</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-extrabold text-[#12233B]">4. Client Obligations</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-extrabold text-[#12233B]">5. Equipment Use and Liability</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-extrabold text-[#12233B]">6. Cancellation</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-extrabold text-[#12233B]">7. Governing Law</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-extrabold text-[#12233B]">8. Contact Us</h2>
            <p>
              For questions about these Terms and Conditions, contact us at{' '}
              <a href="mailto:sales@gulffast.co" className="text-[#2B6CB0] font-semibold hover:underline">sales@gulffast.co</a>{' '}
              or{' '}
              <a href="tel:+966568676710" className="text-[#2B6CB0] font-semibold hover:underline">+966 56 867 6710</a>.
            </p>
          </section>
