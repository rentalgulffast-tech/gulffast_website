    ...
    <div className="py-10 bg-background text-foreground min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white border border-border rounded-2xl p-8 shadow-sm space-y-8 text-sm text-slate-700 leading-relaxed">
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-extrabold text-primary">2. Nature of Services</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-extrabold text-primary">3. Quotations and Pricing</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-extrabold text-primary">4. Client Obligations</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-extrabold text-primary">5. Equipment Use and Liability</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-extrabold text-primary">6. Cancellation</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-extrabold text-primary">7. Governing Law</h2>
            <p>
