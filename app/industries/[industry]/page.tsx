  ...
  return (
    <div className="py-10 bg-white text-[#12233B] min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white border border-[#D7E6F5] rounded-2xl p-8 shadow-sm grid grid-cols-1 lg:grid-cols-12 gap-8 items-center my-8">
          <div className="lg:col-span-8 space-y-3">
            ...
            <div className="flex flex-wrap gap-2 text-xs pt-2">
              {industry.highlights.map((highlight) => (
                <span key={highlight} className="bg-[#EAF4FC] px-3 py-1 rounded-xl border border-[#D7E6F5] text-[#12233B] font-bold">
                  {highlight}
                </span>
              ))}
            </div>
          </div>
          <div className="lg:col-span-4 bg-[#EAF4FC] p-6 rounded-xl border border-[#D7E6F5] text-center space-y-3">
            <h3 className="text-base font-bold text-[#12233B]">Need {industry.name} Project Support?</h3>
            ...
            <Link href="/request-a-quote" className="block w-full py-2.5 bg-[#2B6CB0] hover:bg-[#1D6FB8] text-white font-bold text-xs rounded-xl transition-colors shadow-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-8">
          <Link
            href="/equipment"
            className="bg-white border border-[#D7E6F5] rounded-2xl p-6 hover:border-[#2B6CB0] transition-colors shadow-sm block"
          >
            <h3 className="font-bold text-[#12233B] text-sm mb-1">Browse Equipment Categories →</h3>
          ...
          <Link
            ...
            className="bg-white border border-[#D7E6F5] rounded-2xl p-6 hover:border-[#2B6CB0] transition-colors shadow-sm block"
          >
            <h3 className="font-bold text-[#12233B] text-sm mb-1">Browse Manpower Categories →</h3>
