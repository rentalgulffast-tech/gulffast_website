        ...
        <div className="space-y-8 my-8">
          ...
          <div className="bg-white border border-[#E2DED4] rounded-2xl p-8 shadow-sm grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-8 space-y-3">
              ...
              <div className="flex flex-wrap gap-2 text-xs pt-2">
                <span className="bg-[#F5F2EB] px-3 py-1 rounded-xl border border-[#E2DED4] text-[#0F2942] font-bold">Aramco WQT Welders</span>
                <span className="bg-[#F5F2EB] px-3 py-1 rounded-xl border border-[#E2DED4] text-[#0F2942] font-bold">High-Pressure Compressors</span>
                <span className="bg-[#F5F2EB] px-3 py-1 rounded-xl border border-[#E2DED4] text-[#0F2942] font-bold">6-Pack Welding Racks</span>
                <span className="bg-[#F5F2EB] px-3 py-1 rounded-xl border border-[#E2DED4] text-[#0F2942] font-bold">IVMS Heavy Trucks</span>
              </div>
            </div>
            <div className="lg:col-span-4 bg-[#F9F8F5] p-6 rounded-xl border border-[#E2DED4] text-center space-y-3">
              <h3 className="text-base font-bold text-[#0F2942]">Need Oilfield Compliance Support?</h3>
              ...
              <Link href="/request-a-quote" className="block w-full py-2.5 bg-[#0F2942] hover:bg-[#C2410C] text-white font-bold text-xs rounded-xl transition-colors shadow-sm">
          ...
          <div className="bg-white border border-[#E2DED4] rounded-2xl p-8 shadow-sm grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-8 space-y-3">
              ...
              <div className="flex flex-wrap gap-2 text-xs pt-2">
                <span className="bg-[#F5F2EB] px-3 py-1 rounded-xl border border-[#E2DED4] text-[#0F2942] font-bold">Earthmoving Excavators</span>
                <span className="bg-[#F5F2EB] px-3 py-1 rounded-xl border border-[#E2DED4] text-[#0F2942] font-bold">50-Seat Crew Buses</span>
                <span className="bg-[#F5F2EB] px-3 py-1 rounded-xl border border-[#E2DED4] text-[#0F2942] font-bold">Cuplock Scaffolding</span>
                <span className="bg-[#F5F2EB] px-3 py-1 rounded-xl border border-[#E2DED4] text-[#0F2942] font-bold">Tower Light Fleets</span>
              </div>
            </div>
            <div className="lg:col-span-4 bg-[#F9F8F5] p-6 rounded-xl border border-[#E2DED4] text-center space-y-3">
              <h3 className="text-base font-bold text-[#0F2942]">Building Site Fleet Leasing</h3>
          ...
          <div className="bg-white border border-[#E2DED4] rounded-2xl p-8 shadow-sm grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-8 space-y-3">
              ...
              <div className="flex flex-wrap gap-2 text-xs pt-2">
                <span className="bg-[#F5F2EB] px-3 py-1 rounded-xl border border-[#E2DED4] text-[#0F2942] font-bold">100T Lowbed Haulers</span>
                <span className="bg-[#F5F2EB] px-3 py-1 rounded-xl border border-[#E2DED4] text-[#0F2942] font-bold">D8/D10 Heavy Dozers</span>
                <span className="bg-[#F5F2EB] px-3 py-1 rounded-xl border border-[#E2DED4] text-[#0F2942] font-bold">Off-Grid Power Modules</span>
                <span className="bg-[#F5F2EB] px-3 py-1 rounded-xl border border-[#E2DED4] text-[#0F2942] font-bold">Dewatering Pumps</span>
              </div>
            </div>
            <div className="lg:col-span-4 bg-[#F9F8F5] p-6 rounded-xl border border-[#E2DED4] text-center space-y-3">
              <h3 className="text-base font-bold text-[#0F2942]">NEOM &amp; Giga Project Supply</h3>
          ...
          <div className="bg-white border border-[#E2DED4] rounded-2xl p-8 shadow-sm grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-8 space-y-3">
              ...
              <div className="flex flex-wrap gap-2 text-xs pt-2">
                <span className="bg-[#F5F2EB] px-3 py-1 rounded-xl border border-[#E2DED4] text-[#0F2942] font-bold">500T Mobile Cranes</span>
                <span className="bg-[#F5F2EB] px-3 py-1 rounded-xl border border-[#E2DED4] text-[#0F2942] font-bold">Millwright Fitters</span>
                <span className="bg-[#F5F2EB] px-3 py-1 rounded-xl border border-[#E2DED4] text-[#0F2942] font-bold">Instrument Technicians</span>
                <span className="bg-[#F5F2EB] px-3 py-1 rounded-xl border border-[#E2DED4] text-[#0F2942] font-bold">HV Cable Jointers</span>
              </div>
            </div>
            <div className="lg:col-span-4 bg-[#F9F8F5] p-6 rounded-xl border border-[#E2DED4] text-center space-y-3">
              <h3 className="text-base font-bold text-[#0F2942]">EPC Turnkey Manpower</h3>
