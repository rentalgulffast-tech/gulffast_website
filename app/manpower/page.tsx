          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {allCategories.map((category) => (
              <Link
                ...
                className="bg-white border border-[#E2DED4] rounded-2xl p-5 hover:border-[#0F172A] transition-colors shadow-sm block"
              >
                <h3 className="font-bold text-[#0F172A] text-sm mb-1">{category.name}</h3>
